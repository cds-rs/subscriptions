...
flowchart LR
    ...
    CRMWwDAL_sa74[("CRMWwDAL…sa74")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| CRMWwDAL_sa74
```
...
flowchart LR
    ...
    Token[Token]:::owner
    CRMWwDAL_sa74[("CRMWwDAL…sa74")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| CRMWwDAL_sa74
```
...
└── subscriptions::RevokeDelegation [1] ✗ 223cu  signer=mallory
    └── Error: Unauthorized
Error: InstructionError(0, Custom(130))
Compute Units (this run): 223
Fee: 5000 lamports
Legend (2):
