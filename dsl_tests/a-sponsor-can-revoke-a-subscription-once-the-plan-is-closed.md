...
flowchart LR
    ...
    FMX3RkoJ_QV8F[("FMX3RkoJ…QV8F")]:::writable
    ...
    subscriptions -->|writes| FMX3RkoJ_QV8F
    Token -->|writes| FMX3RkoJ_QV8F
```
...
flowchart LR
    ...
    Token[Token]:::owner
    FMX3RkoJ_QV8F[("FMX3RkoJ…QV8F")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| FMX3RkoJ_QV8F
```
