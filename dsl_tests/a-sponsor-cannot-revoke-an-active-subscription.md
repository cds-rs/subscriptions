...
flowchart LR
    ...
    C6ex8DqW_VpTC[("C6ex8DqW…VpTC")]:::writable
    ...
    subscriptions -->|writes| C6ex8DqW_VpTC
    Token -->|writes| C6ex8DqW_VpTC
```
...
flowchart LR
    ...
    Token[Token]:::owner
    C6ex8DqW_VpTC[("C6ex8DqW…VpTC")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| C6ex8DqW_VpTC
```
