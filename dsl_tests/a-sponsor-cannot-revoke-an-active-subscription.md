...
flowchart LR
    ...
    GdTzxUQq_wfbq[("GdTzxUQq…wfbq")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| GdTzxUQq_wfbq
```
...
flowchart LR
    ...
    Token[Token]:::owner
    GdTzxUQq_wfbq[("GdTzxUQq…wfbq")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| GdTzxUQq_wfbq
```
...
└── subscriptions::RevokeDelegation [1] ✗ 480cu  signer=sponsor
    └── Error: Unauthorized
