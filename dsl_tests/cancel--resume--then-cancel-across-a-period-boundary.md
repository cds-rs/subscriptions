## Cancel, resume, then cancel across a period boundary — PASS
...
flowchart LR
    ...
    EBxfV2LD_rNZn[("EBxfV2LD…rNZn")]:::writable
    ...
    subscriptions -->|writes| EBxfV2LD_rNZn
    Token -->|writes| EBxfV2LD_rNZn
```
...
flowchart LR
    ...
    Token[Token]:::owner
    EBxfV2LD_rNZn[("EBxfV2LD…rNZn")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| EBxfV2LD_rNZn
```
...
**CancelSubscription (first): structured CPI tree**
...
**CancelSubscription (first): sequence diagram**
...
**CancelSubscription (first): sequence diagram, with lifelines**
...
**CancelSubscription (first): authority graph**
...
**CancelSubscription (first): ownership graph**
...
### Alice cancels again past the original period boundary

**CancelSubscription (second): structured CPI tree**
...
**CancelSubscription (second): sequence diagram**
...
**CancelSubscription (second): sequence diagram, with lifelines**
...
**CancelSubscription (second): authority graph**
...
**CancelSubscription (second): ownership graph**
...
- [x] the second cancel advances the expiry past the prior boundary: `true`
