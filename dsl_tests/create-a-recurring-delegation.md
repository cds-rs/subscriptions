...
flowchart LR
    ...
    2JuNJ6Dc_BeB1[("2JuNJ6Dc…BeB1")]:::writable
    ...
    subscriptions -->|writes| 2JuNJ6Dc_BeB1
    Token -->|writes| 2JuNJ6Dc_BeB1
```
...
flowchart LR
    ...
    Token[Token]:::owner
    2JuNJ6Dc_BeB1[("2JuNJ6Dc…BeB1")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 2JuNJ6Dc_BeB1
```
