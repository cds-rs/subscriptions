## Fixed transfer within the drift window succeeds — PASS
...
flowchart LR
    ...
    7tv8jNcj_1je2[("7tv8jNcj…1je2")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7tv8jNcj_1je2
```
...
flowchart LR
    ...
    Token[Token]:::owner
    7tv8jNcj_1je2[("7tv8jNcj…1je2")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7tv8jNcj_1je2
```
...
**TransferFixed (within drift window): structured CPI tree**
...
**TransferFixed (within drift window): sequence diagram**
...
**TransferFixed (within drift window): sequence diagram, with lifelines**
...
**TransferFixed (within drift window): authority graph**
...
flowchart LR
    ...
    SubAuthority[(SubAuthority)]:::writable
    7tv8jNcj_1je2[("7tv8jNcj…1je2")]:::writable
    55yezQts_LuCD[("55yezQts…LuCD")]:::writable
    bob([bob]):::signer
    Token[Token]:::program
    ...
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7tv8jNcj_1je2
    subscriptions -->|writes| 55yezQts_LuCD
```

**TransferFixed (within drift window): ownership graph**
...
flowchart LR
    ...
    Token[Token]:::owner
    7tv8jNcj_1je2[("7tv8jNcj…1je2")]:::account
    55yezQts_LuCD[("55yezQts…LuCD")]:::account
    System[System]:::owner
    bob[(bob)]:::account
    subscriptions -->|owns| FixedDelegation
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7tv8jNcj_1je2
    Token -->|owns| 55yezQts_LuCD
    System -->|owns| bob
```
