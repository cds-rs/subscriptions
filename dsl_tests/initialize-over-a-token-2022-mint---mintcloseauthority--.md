...
flowchart LR
    ...
    bzdaM76B_yxwh[("bzdaM76B…yxwh")]:::writable
    ...
    subscriptions -->|writes| bzdaM76B_yxwh
    Token_2022 -->|writes| bzdaM76B_yxwh
```
...
flowchart LR
    ...
    bzdaM76B_yxwh[("bzdaM76B…yxwh")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| bzdaM76B_yxwh
```
