...
flowchart LR
    ...
    7UJdsiMg_WUfY[("7UJdsiMg…WUfY")]:::writable
    ...
    subscriptions -->|writes| 7UJdsiMg_WUfY
    Token_2022 -->|writes| 7UJdsiMg_WUfY
```
...
flowchart LR
    ...
    7UJdsiMg_WUfY[("7UJdsiMg…WUfY")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| 7UJdsiMg_WUfY
```
