...
flowchart LR
    ...
    D7DgrZqa_77ut[("D7DgrZqa…77ut")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| D7DgrZqa_77ut
```
...
flowchart LR
    ...
    Token[Token]:::owner
    D7DgrZqa_77ut[("D7DgrZqa…77ut")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| D7DgrZqa_77ut
```
...
└── subscriptions::RevokeDelegation [1] ✗ 395cu  signer=mallory
    └── Error: Unauthorized
Error: InstructionError(0, Custom(130))
Compute Units (this run): 395
Fee: 5000 lamports
Legend (2):
