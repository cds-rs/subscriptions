...
flowchart LR
    ...
    En7wnLCU_YxAC[("En7wnLCU…YxAC")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| En7wnLCU_YxAC
```
...
flowchart LR
    ...
    Token[Token]:::owner
    En7wnLCU_YxAC[("En7wnLCU…YxAC")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| En7wnLCU_YxAC
```
...
└── subscriptions::TransferRecurring [1] ✗ 1022cu  signer=bob
    └── Error: AmountExceedsPeriodLimit
Error: InstructionError(0, Custom(400))
Compute Units (this run): 1022
Fee: 5000 lamports
Legend (2):
