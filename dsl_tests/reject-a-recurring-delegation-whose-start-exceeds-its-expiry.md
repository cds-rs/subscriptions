...
flowchart LR
    ...
    CiUu4rvp_1NGe[("CiUu4rvp…1NGe")]:::writable
    ...
    subscriptions -->|writes| CiUu4rvp_1NGe
    Token -->|writes| CiUu4rvp_1NGe
```
...
flowchart LR
    ...
    Token[Token]:::owner
    CiUu4rvp_1NGe[("CiUu4rvp…1NGe")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| CiUu4rvp_1NGe
```
