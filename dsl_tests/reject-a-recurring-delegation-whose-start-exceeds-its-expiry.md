...
flowchart LR
    ...
    54xm5wnj_8FX8[("54xm5wnj…8FX8")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 54xm5wnj_8FX8
```
...
flowchart LR
    ...
    Token[Token]:::owner
    54xm5wnj_8FX8[("54xm5wnj…8FX8")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 54xm5wnj_8FX8
```
...
Transaction  signers=[alice]
└── subscriptions::CreateRecurringDelegation [1] ✗ 371cu  signer=alice
    └── Error: RecurringDelegationStartTimeGreaterThanExpiry
