...
sequenceDiagram
    ...
    participant System
    participant Token
    alice ->> subscriptions: InitSubscriptionAuthority (22742cu)
...
sequenceDiagram
    ...
    subscriptions -->>- alice: ok (22742cu)
```
...
flowchart LR
    ...
    8mUUiSAn_2U6U[("8mUUiSAn…2U6U")]:::writable
    ...
    subscriptions -->|writes| 8mUUiSAn_2U6U
    Token -->|writes| 8mUUiSAn_2U6U
```
...
flowchart LR
    ...
    Token[Token]:::owner
    8mUUiSAn_2U6U[("8mUUiSAn…2U6U")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 8mUUiSAn_2U6U
```
