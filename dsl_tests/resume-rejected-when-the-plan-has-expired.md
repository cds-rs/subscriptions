...
flowchart LR
    ...
    EFea1QBs_GcF6[("EFea1QBs…GcF6")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| EFea1QBs_GcF6
```
...
flowchart LR
    ...
    Token[Token]:::owner
    EFea1QBs_GcF6[("EFea1QBs…GcF6")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| EFea1QBs_GcF6
```
...
Transaction  signers=[alice]
└── subscriptions::ResumeSubscription [1] ✗ 451cu  signer=alice
    └── Error: PlanExpired
Error: InstructionError(0, Custom(501))
Compute Units (this run): 451
Fee: 5000 lamports
Legend (2):
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
