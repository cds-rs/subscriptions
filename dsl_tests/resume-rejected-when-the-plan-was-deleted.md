...
flowchart LR
    ...
    6cf3Fyf3_ZcwX[("6cf3Fyf3…ZcwX")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 6cf3Fyf3_ZcwX
```
...
flowchart LR
    ...
    Token[Token]:::owner
    6cf3Fyf3_ZcwX[("6cf3Fyf3…ZcwX")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 6cf3Fyf3_ZcwX
```
...
Transaction  signers=[alice]
└── subscriptions::ResumeSubscription [1] ✗ 403cu  signer=alice
    └── Error: PlanClosed
Error: InstructionError(0, Custom(516))
Compute Units (this run): 403
Fee: 5000 lamports
Legend (2):
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
