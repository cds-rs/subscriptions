...
flowchart LR
    ...
    7UbgKPaK_iQcg[("7UbgKPaK…iQcg")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7UbgKPaK_iQcg
```
...
flowchart LR
    ...
    Token[Token]:::owner
    7UbgKPaK_iQcg[("7UbgKPaK…iQcg")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7UbgKPaK_iQcg
```
...
└── subscriptions::ResumeSubscription [1] ✗ 363cu  signer=mallory
    └── Error: Unauthorized
