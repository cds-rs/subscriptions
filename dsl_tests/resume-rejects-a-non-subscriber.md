## Resume rejects a non-subscriber — PASS
...
### Mallory attempts to resume Alice's subscription

**ResumeSubscription (non-subscriber): structured CPI tree**

```text

── subscriptions::ResumeSubscription ───────────────────────
Transaction  signers=[mallory]
└── subscriptions::ResumeSubscription [1] ✗ 369cu  signer=mallory
