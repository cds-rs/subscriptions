...
flowchart LR
    ...
    HmW68DPu_DakB[("HmW68DPu…DakB")]:::writable
    ...
    subscriptions -->|writes| HmW68DPu_DakB
    Token -->|writes| HmW68DPu_DakB
```
...
flowchart LR
    ...
    Token[Token]:::owner
    HmW68DPu_DakB[("HmW68DPu…DakB")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| HmW68DPu_DakB
```
