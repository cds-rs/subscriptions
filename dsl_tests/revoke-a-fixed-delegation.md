...
flowchart LR
    ...
    8MSXMX6A_GUwF[("8MSXMX6A…GUwF")]:::writable
    ...
    subscriptions -->|writes| 8MSXMX6A_GUwF
    Token -->|writes| 8MSXMX6A_GUwF
```
...
flowchart LR
    ...
    Token[Token]:::owner
    8MSXMX6A_GUwF[("8MSXMX6A…GUwF")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 8MSXMX6A_GUwF
```
