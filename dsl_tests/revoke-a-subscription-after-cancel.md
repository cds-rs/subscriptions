## Revoke a subscription after cancel — PASS
...
flowchart LR
    ...
    8a2gLADy_mwD2[("8a2gLADy…mwD2")]:::writable
    ...
    subscriptions -->|writes| 8a2gLADy_mwD2
    Token -->|writes| 8a2gLADy_mwD2
```
...
flowchart LR
    ...
    Token[Token]:::owner
    8a2gLADy_mwD2[("8a2gLADy…mwD2")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 8a2gLADy_mwD2
```
...
### Alice revokes the cancelled subscription

**RevokeSubscription: structured CPI tree**

```text

── subscriptions::RevokeDelegation ─────────────────────────
Transaction  signers=[alice]
└── subscriptions::RevokeDelegation [1] ✓ 453cu  signer=alice
Compute Units (this run): 453
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
...
**RevokeSubscription: sequence diagram**
...
sequenceDiagram
    ...
    participant alice
    participant subscriptions
    alice ->> subscriptions: RevokeDelegation (453cu)
```

**RevokeSubscription: sequence diagram, with lifelines**
...
sequenceDiagram
    ...
    subscriptions -->>- alice: ok (453cu)
```

**RevokeSubscription: authority graph**
...
**RevokeSubscription: ownership graph**
