...
flowchart LR
    ...
    BJdtmpMz_ARip[("BJdtmpMz…ARip")]:::writable
    ...
    subscriptions -->|writes| BJdtmpMz_ARip
    Token -->|writes| BJdtmpMz_ARip
```
...
flowchart LR
    ...
    Token[Token]:::owner
    BJdtmpMz_ARip[("BJdtmpMz…ARip")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| BJdtmpMz_ARip
```
