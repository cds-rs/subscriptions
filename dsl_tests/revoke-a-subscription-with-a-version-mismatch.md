...
flowchart LR
    ...
    7MqMutTC_TNwX[("7MqMutTC…TNwX")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7MqMutTC_TNwX
```
...
flowchart LR
    ...
    Token[Token]:::owner
    7MqMutTC_TNwX[("7MqMutTC…TNwX")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7MqMutTC_TNwX
```
...
Transaction  signers=[alice]
└── subscriptions::RevokeDelegation [1] ✗ 219cu  signer=alice
    └── Error: MigrationRequired
Error: InstructionError(0, Custom(134))
Compute Units (this run): 219
Fee: 5000 lamports
Legend (2):
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
