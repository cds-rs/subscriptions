## Revoke a subscription without cancelling is rejected — PASS
...
flowchart LR
    ...
    DU6iowh8_zy3f[("DU6iowh8…zy3f")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| DU6iowh8_zy3f
```
...
flowchart LR
    ...
    Token[Token]:::owner
    DU6iowh8_zy3f[("DU6iowh8…zy3f")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| DU6iowh8_zy3f
```
...
### Alice tries to revoke without cancelling first

**RevokeSubscription (not cancelled): structured CPI tree**

```text

Transaction  signers=[alice]
└── subscriptions::RevokeDelegation [1] ✗ 400cu  signer=alice
    └── Error: SubscriptionNotCancelled
Error: InstructionError(0, Custom(510))
Compute Units (this run): 400
Fee: 5000 lamports
Legend (2):
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
