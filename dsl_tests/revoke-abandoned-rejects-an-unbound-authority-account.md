## Revoke-abandoned rejects an unbound authority account — PASS
...
flowchart LR
    ...
    BqVdXE9L_ko7n[("BqVdXE9L…ko7n")]:::writable
    ...
    subscriptions -->|writes| BqVdXE9L_ko7n
    Token -->|writes| BqVdXE9L_ko7n
```
...
flowchart LR
    ...
    Token[Token]:::owner
    BqVdXE9L_ko7n[("BqVdXE9L…ko7n")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| BqVdXE9L_ko7n
```
...
### The sponsor sweeps but points at an unrelated authority account

**RevokeAbandonedDelegation (unbound authority): structured CPI tree**

```text

── subscriptions::RevokeAbandonedDelegation ────────────────
Transaction  signers=[sponsor]
└── subscriptions::RevokeAbandonedDelegation [1] ✗ 284cu  signer=sponsor
    └── Error: Unauthorized (0x82)
Error: InstructionError(0, Custom(130))
Compute Units (this run): 284
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  sponsor       = 47cncVPgU4mK37H7VvxLCCsoDEKYaVhNLHHp4MbnEwvx
