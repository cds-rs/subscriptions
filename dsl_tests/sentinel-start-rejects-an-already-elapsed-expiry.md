...
flowchart LR
    ...
    5WBssRch_LZfy[("5WBssRch…LZfy")]:::writable
    ...
    subscriptions -->|writes| 5WBssRch_LZfy
    Token -->|writes| 5WBssRch_LZfy
```
...
flowchart LR
    ...
    Token[Token]:::owner
    5WBssRch_LZfy[("5WBssRch…LZfy")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 5WBssRch_LZfy
```
