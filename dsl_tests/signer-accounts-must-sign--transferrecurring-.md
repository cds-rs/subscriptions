...
flowchart LR
    ...
    GjX2vViy_H1T9[("GjX2vViy…H1T9")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| GjX2vViy_H1T9
```
...
flowchart LR
    ...
    Token[Token]:::owner
    GjX2vViy_H1T9[("GjX2vViy…H1T9")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| GjX2vViy_H1T9
```
...
└── subscriptions::TransferRecurring [1] ✗ 602cu
    └── Error: NotSigner
Error: InstructionError(0, Custom(100))
Compute Units (this run): 602
Fee: 5000 lamports
Legend (2):
