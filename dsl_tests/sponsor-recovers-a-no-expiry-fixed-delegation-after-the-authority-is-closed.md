...
flowchart LR
    ...
    9mmEECey_Z8qe[("9mmEECey…Z8qe")]:::writable
    ...
    subscriptions -->|writes| 9mmEECey_Z8qe
    Token -->|writes| 9mmEECey_Z8qe
```
...
flowchart LR
    ...
    Token[Token]:::owner
    9mmEECey_Z8qe[("9mmEECey…Z8qe")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 9mmEECey_Z8qe
```
