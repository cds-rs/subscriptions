## Subscribe (happy path) — PASS

> Alice subscribes to the merchant's active plan
...
flowchart LR
    ...
    7LEntB89_Sunj[("7LEntB89…Sunj")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7LEntB89_Sunj
```
...
flowchart LR
    ...
    Token[Token]:::owner
    7LEntB89_Sunj[("7LEntB89…Sunj")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7LEntB89_Sunj
```
...
- [x] the subscription account is sized correctly: `155`
- [x] the account is tagged SubscriptionDelegation: `4`
- [x] the delegator is Alice: `FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF`
- [x] the delegatee is the plan: `6rGpcSJciD37aqctggyrJTLjrL1n73dgm5U8JFoNjWxW`
- [x] the payer defaults to Alice: `FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF`
- [x] nothing has been pulled yet: `0`
- [x] the subscription has no expiry: `0`
