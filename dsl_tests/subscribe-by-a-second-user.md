...
flowchart LR
    ...
    CDjYbmHa_aZeR[("CDjYbmHa…aZeR")]:::writable
    ...
    subscriptions -->|writes| CDjYbmHa_aZeR
    Token -->|writes| CDjYbmHa_aZeR
```
...
flowchart LR
    ...
    Token[Token]:::owner
    CDjYbmHa_aZeR[("CDjYbmHa…aZeR")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| CDjYbmHa_aZeR
```
...
sequenceDiagram
    ...
    participant System
    participant Token
    bob ->> subscriptions: InitSubscriptionAuthority (10742cu)
    subscriptions ->> System: CreateAccount
    subscriptions ->> Token: Approve (126cu)
```
...
flowchart LR
    ...
    bob([bob]):::signer
    SubAuthority([SubAuthority]):::signer
    4hGGUosE_A69e[("4hGGUosE…A69e")]:::writable
    System[System]:::program
    Token[Token]:::program
    ...
    bob -->|signs| Token
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 4hGGUosE_A69e
    Token -->|writes| 4hGGUosE_A69e
```
...
flowchart LR
    ...
    SubAuthority[(SubAuthority)]:::account
    Token[Token]:::owner
    4hGGUosE_A69e[("4hGGUosE…A69e")]:::account
    System -->|owns| bob
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 4hGGUosE_A69e
```
