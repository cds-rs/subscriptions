...
flowchart LR
    ...
    247zwUNB_LAeL[("247zwUNB…LAeL")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 247zwUNB_LAeL
```
...
flowchart LR
    ...
    Token[Token]:::owner
    247zwUNB_LAeL[("247zwUNB…LAeL")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 247zwUNB_LAeL
```
...
sequenceDiagram
    ...
    participant System
    participant Token
    bob ->> subscriptions: InitSubscriptionAuthority (6242cu)
    subscriptions ->> System: CreateAccount
    subscriptions ->> Token: Approve (126cu)
```
...
flowchart LR
    ...
    bob([bob]):::signer
    SubAuthority[(SubAuthority)]:::writable
    4t6WHYkK_k7V7[("4t6WHYkK…k7V7")]:::writable
    System[System]:::program
    Token[Token]:::program
    bob -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 4t6WHYkK_k7V7
```
...
flowchart LR
    ...
    SubAuthority[(SubAuthority)]:::account
    Token[Token]:::owner
    4t6WHYkK_k7V7[("4t6WHYkK…k7V7")]:::account
    System -->|owns| bob
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 4t6WHYkK_k7V7
```
...
flowchart LR
    ...
    subscriptions[subscriptions]:::program
    bob([bob]):::signer
    APpsmbcv_ccYB[("APpsmbcv…ccYB")]:::writable
    System[System]:::program
    bob -->|signs| subscriptions
