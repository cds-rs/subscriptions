...
flowchart LR
    ...
    D1Gubqr4_wzHz[("D1Gubqr4…wzHz")]:::writable
    ...
    subscriptions -->|writes| D1Gubqr4_wzHz
    Token -->|writes| D1Gubqr4_wzHz
```
...
flowchart LR
    ...
    Token[Token]:::owner
    D1Gubqr4_wzHz[("D1Gubqr4…wzHz")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| D1Gubqr4_wzHz
```
...
flowchart LR
    ...
    alice([alice]):::signer
    SubAuthority([SubAuthority]):::signer
    HgM2Xb8G_J93r[("HgM2Xb8G…J93r")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    alice -->|signs| System
    ...
    alice -->|signs| Token
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| HgM2Xb8G_J93r
    Token -->|writes| HgM2Xb8G_J93r
```
...
flowchart LR
    ...
    SubAuthority[(SubAuthority)]:::account
    Token[Token]:::owner
    HgM2Xb8G_J93r[("HgM2Xb8G…J93r")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| HgM2Xb8G_J93r
```
...
Transaction  signers=[alice]
└── subscriptions::Subscribe [1] ✗ 2253cu  signer=alice
    └── Error: MintMismatch (0x7d)
Error: InstructionError(0, Custom(125))
Compute Units (this run): 2253
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
