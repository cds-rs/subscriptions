...
flowchart LR
    ...
    C6EALHux_KvC3[("C6EALHux…KvC3")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| C6EALHux_KvC3
```
...
flowchart LR
    ...
    Token[Token]:::owner
    C6EALHux_KvC3[("C6EALHux…KvC3")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| C6EALHux_KvC3
```
...
flowchart LR
    ...
    alice([alice]):::signer
    SubAuthority[(SubAuthority)]:::writable
    7hJgeYkn_nt3q[("7hJgeYkn…nt3q")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 7hJgeYkn_nt3q
```
...
flowchart LR
    ...
    SubAuthority[(SubAuthority)]:::account
    Token[Token]:::owner
    7hJgeYkn_nt3q[("7hJgeYkn…nt3q")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7hJgeYkn_nt3q
```
