...
flowchart LR
    ...
    5eEWXcrE_3KGz[("5eEWXcrE…3KGz")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 5eEWXcrE_3KGz
```
...
flowchart LR
    ...
    Token[Token]:::owner
    5eEWXcrE_3KGz[("5eEWXcrE…3KGz")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 5eEWXcrE_3KGz
```
...
Transaction  signers=[alice]
└── subscriptions::Subscribe [1] ✗ 2131cu  signer=alice
    └── Error: PlanExpired
Error: InstructionError(0, Custom(501))
Compute Units (this run): 2131
Fee: 5000 lamports
Legend (2):
  alice         = FXddRd8CdAC8SWKT3Ataasn69R7rbTfQZcKg8ejyrUbF
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
