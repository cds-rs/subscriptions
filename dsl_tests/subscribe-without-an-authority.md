## Subscribe without an authority — PASS
...
flowchart LR
    ...
    zbDNYpTr_5cMY[("zbDNYpTr…5cMY")]:::writable
    ...
    subscriptions -->|writes| zbDNYpTr_5cMY
    Token -->|writes| zbDNYpTr_5cMY
```
...
flowchart LR
    ...
    Token[Token]:::owner
    zbDNYpTr_5cMY[("zbDNYpTr…5cMY")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| zbDNYpTr_5cMY
```
...
### Charlie subscribes with no authority PDA in place

**Subscribe (no authority): structured CPI tree**

```text

── subscriptions::Subscribe ────────────────────────────────
Transaction  signers=[charlie]
└── subscriptions::Subscribe [1] ✗ 356cu  signer=charlie
    └── Error: InvalidSubscriptionAuthorityPda (0x67)
Error: InstructionError(0, Custom(103))
Compute Units (this run): 356
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
