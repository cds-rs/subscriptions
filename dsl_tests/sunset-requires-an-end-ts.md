## Sunset requires an end_ts — PASS
...
### The merchant tries to sunset without an end timestamp

**UpdatePlan (sunset, no end_ts): structured CPI tree**

```text

── subscriptions::UpdatePlan ───────────────────────────────
Transaction  signers=[merchant]
└── subscriptions::UpdatePlan [1] ✗ 255cu  signer=merchant
    └── Error: SunsetRequiresEndTs (0x202)
Error: InstructionError(0, Custom(514))
Compute Units (this run): 255
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  merchant      = J4fPsxKiTTKiXSiN9bgZ5JBrVgTM9c6N8tjhLN8gfdTq
