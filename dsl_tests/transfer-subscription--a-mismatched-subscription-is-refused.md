...
flowchart LR
    ...
    C7cbpjsq_zFAb[("C7cbpjsq…zFAb")]:::writable
    ...
    subscriptions -->|writes| C7cbpjsq_zFAb
    Token -->|writes| C7cbpjsq_zFAb
```
...
flowchart LR
    ...
    Token[Token]:::owner
    C7cbpjsq_zFAb[("C7cbpjsq…zFAb")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| C7cbpjsq_zFAb
```
