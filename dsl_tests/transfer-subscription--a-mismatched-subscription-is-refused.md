...
flowchart LR
    ...
    EEXZB4ra_Qta6[("EEXZB4ra…Qta6")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| EEXZB4ra_Qta6
```
...
flowchart LR
    ...
    Token[Token]:::owner
    EEXZB4ra_Qta6[("EEXZB4ra…Qta6")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| EEXZB4ra_Qta6
```
...
flowchart LR
    ...
    subscriptions[subscriptions]:::program
    merchant([merchant]):::signer
    Plan_2[("Plan 2")]:::writable
    System[System]:::program
    merchant -->|signs| subscriptions
    subscriptions -->|writes| Plan_2
```
...
flowchart LR
    ...
    merchant[(merchant)]:::account
    subscriptions[subscriptions]:::owner
    Plan_2[("Plan 2")]:::account
    System -->|owns| merchant
    subscriptions -->|owns| Plan_2
```
...
Transaction  signers=[merchant]
└── subscriptions::TransferSubscription [1] ✗ 1084cu  signer=merchant
    └── Error: SubscriptionPlanMismatch
Error: InstructionError(0, Custom(505))
Compute Units (this run): 1084
Fee: 5000 lamports
Legend (2):
  merchant      = J4fPsxKiTTKiXSiN9bgZ5JBrVgTM9c6N8tjhLN8gfdTq
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
