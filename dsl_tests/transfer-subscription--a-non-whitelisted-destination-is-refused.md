...
flowchart LR
    ...
    hELiDLg2_xBDs[("hELiDLg2…xBDs")]:::writable
    ...
    subscriptions -->|writes| hELiDLg2_xBDs
    Token -->|writes| hELiDLg2_xBDs
```
...
flowchart LR
    ...
    Token[Token]:::owner
    hELiDLg2_xBDs[("hELiDLg2…xBDs")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| hELiDLg2_xBDs
```
