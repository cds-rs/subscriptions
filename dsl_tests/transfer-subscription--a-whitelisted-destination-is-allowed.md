...
flowchart LR
    ...
    5Hi9xP41_i1Tx[("5Hi9xP41…i1Tx")]:::writable
    ...
    subscriptions -->|writes| 5Hi9xP41_i1Tx
    Token -->|writes| 5Hi9xP41_i1Tx
```
...
flowchart LR
    ...
    Token[Token]:::owner
    5Hi9xP41_i1Tx[("5Hi9xP41…i1Tx")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 5Hi9xP41_i1Tx
```
...
Transaction  signers=[merchant]
└── subscriptions::TransferSubscription [1] ✓ 13393cu  signer=merchant
    ├── Token::TransferChecked [2] ✓ 113cu
    └── subscriptions::EmitEvent [2] ✓ 137cu
Compute Units (this run): 13393
Fee: 5000 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  merchant      = J4fPsxKiTTKiXSiN9bgZ5JBrVgTM9c6N8tjhLN8gfdTq
...
sequenceDiagram
    ...
    participant subscriptions
    participant Token
    merchant ->> subscriptions: TransferSubscription (13393cu)
...
sequenceDiagram
    ...
    subscriptions -->>- merchant: ok (13393cu)
```
...
flowchart LR
    ...
    5Hi9xP41_i1Tx[("5Hi9xP41…i1Tx")]:::writable
    4U58x5fF_WpeZ[("4U58x5fF…WpeZ")]:::writable
    merchant([merchant]):::signer
    Token[Token]:::program
    SubAuthority([SubAuthority]):::signer
    ...
    subscriptions -->|writes| 5Hi9xP41_i1Tx
    subscriptions -->|writes| 4U58x5fF_WpeZ
    Token -->|writes| 5Hi9xP41_i1Tx
    Token -->|writes| 4U58x5fF_WpeZ
```
...
flowchart LR
    ...
    Token[Token]:::owner
    5Hi9xP41_i1Tx[("5Hi9xP41…i1Tx")]:::account
    4U58x5fF_WpeZ[("4U58x5fF…WpeZ")]:::account
    System[System]:::owner
    merchant[(merchant)]:::account
    subscriptions -->|owns| Subscription
    Token -->|owns| 5Hi9xP41_i1Tx
    Token -->|owns| 4U58x5fF_WpeZ
    System -->|owns| merchant
```
