...
flowchart LR
    ...
    61omGbad_ehMk[("61omGbad…ehMk")]:::writable
    ...
    subscriptions -->|writes| 61omGbad_ehMk
    Token -->|writes| 61omGbad_ehMk
```
...
flowchart LR
    ...
    Token[Token]:::owner
    61omGbad_ehMk[("61omGbad…ehMk")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 61omGbad_ehMk
```
