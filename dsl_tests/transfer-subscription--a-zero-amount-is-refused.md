...
flowchart LR
    ...
    Dqysr7LT_MaQd[("Dqysr7LT…MaQd")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| Dqysr7LT_MaQd
```
...
flowchart LR
    ...
    Token[Token]:::owner
    Dqysr7LT_MaQd[("Dqysr7LT…MaQd")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| Dqysr7LT_MaQd
```
...
Transaction  signers=[merchant]
└── subscriptions::TransferSubscription [1] ✗ 1204cu  signer=merchant
    └── Error: InvalidAmount
Error: InstructionError(0, Custom(129))
Compute Units (this run): 1204
Fee: 5000 lamports
Legend (2):
  merchant      = J4fPsxKiTTKiXSiN9bgZ5JBrVgTM9c6N8tjhLN8gfdTq
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
