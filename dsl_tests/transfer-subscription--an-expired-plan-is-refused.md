...
flowchart LR
    ...
    6z1oAHma_PXzo[("6z1oAHma…PXzo")]:::writable
    ...
    subscriptions -->|writes| 6z1oAHma_PXzo
    Token -->|writes| 6z1oAHma_PXzo
```
...
flowchart LR
    ...
    Token[Token]:::owner
    6z1oAHma_PXzo[("6z1oAHma…PXzo")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 6z1oAHma_PXzo
```
