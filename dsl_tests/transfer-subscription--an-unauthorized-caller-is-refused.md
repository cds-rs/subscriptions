...
flowchart LR
    ...
    2KDuNYuk_A3j5[("2KDuNYuk…A3j5")]:::writable
    ...
    subscriptions -->|writes| 2KDuNYuk_A3j5
    Token -->|writes| 2KDuNYuk_A3j5
```
...
flowchart LR
    ...
    Token[Token]:::owner
    2KDuNYuk_A3j5[("2KDuNYuk…A3j5")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 2KDuNYuk_A3j5
```
