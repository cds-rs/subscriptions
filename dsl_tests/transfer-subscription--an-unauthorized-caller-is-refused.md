## Transfer subscription: an unauthorized caller is refused — PASS
...
### Mallory, neither merchant nor puller, attempts a pull

**TransferSubscription (unauthorized): structured CPI tree**

```text

Transaction  signers=[mallory]
└── subscriptions::TransferSubscription [1] ✗ 940cu  signer=mallory
    └── Error: Unauthorized
Error: InstructionError(0, Custom(130))
Compute Units (this run): 940
Fee: 5000 lamports
Legend (2):
