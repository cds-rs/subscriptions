## Transfer subscription: cancellation blocks the next period — PASS
...
flowchart LR
    ...
    GbTqwoW4_wmWh[("GbTqwoW4…wmWh")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| GbTqwoW4_wmWh
```
...
flowchart LR
    ...
    Token[Token]:::owner
    GbTqwoW4_wmWh[("GbTqwoW4…wmWh")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| GbTqwoW4_wmWh
```
...
### The clock advances past the period boundary

**TransferSubscription (next period blocked): structured CPI tree**
