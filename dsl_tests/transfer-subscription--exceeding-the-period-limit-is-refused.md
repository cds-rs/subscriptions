...
flowchart LR
    ...
    5RfGmVJZ_C3Tn[("5RfGmVJZ…C3Tn")]:::writable
    System[System]:::program
    Token[Token]:::program
    alice -->|signs| subscriptions
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| 5RfGmVJZ_C3Tn
```
...
flowchart LR
    ...
    Token[Token]:::owner
    5RfGmVJZ_C3Tn[("5RfGmVJZ…C3Tn")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 5RfGmVJZ_C3Tn
```
...
Transaction  signers=[merchant]
└── subscriptions::TransferSubscription [1] ✗ 1244cu  signer=merchant
    └── Error: AmountExceedsPeriodLimit
Error: InstructionError(0, Custom(400))
Compute Units (this run): 1244
Fee: 5000 lamports
Legend (2):
  merchant      = J4fPsxKiTTKiXSiN9bgZ5JBrVgTM9c6N8tjhLN8gfdTq
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
