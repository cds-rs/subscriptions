...
flowchart LR
    ...
    3RuKLGpT_8cqv[("3RuKLGpT…8cqv")]:::writable
    ...
    subscriptions -->|writes| 3RuKLGpT_8cqv
    Token -->|writes| 3RuKLGpT_8cqv
```
...
flowchart LR
    ...
    Token[Token]:::owner
    3RuKLGpT_8cqv[("3RuKLGpT…8cqv")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 3RuKLGpT_8cqv
```
