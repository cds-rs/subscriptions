...
### The merchant sunsets the plan with a new end timestamp and metadata

**UpdatePlan: structured CPI tree**
...
**UpdatePlan: sequence diagram, with lifelines**
