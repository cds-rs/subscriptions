## Update a plan fills the puller whitelist to capacity — PASS
...
### The merchant sets the maximum of four pullers

**UpdatePlan (max pullers): structured CPI tree**
...
**UpdatePlan (max pullers): sequence diagram**
...
**UpdatePlan (max pullers): sequence diagram, with lifelines**
...
**UpdatePlan (max pullers): authority graph**
...
**UpdatePlan (max pullers): ownership graph**
