## Update a plan replaces the puller whitelist — PASS
...
### The merchant replaces the whitelist with a single new puller

**UpdatePlan (replace pullers): structured CPI tree**
...
**UpdatePlan (replace pullers): sequence diagram**
...
**UpdatePlan (replace pullers): sequence diagram, with lifelines**
...
**UpdatePlan (replace pullers): authority graph**
...
**UpdatePlan (replace pullers): ownership graph**
...
- [x] puller 0 is the replacement: `11F8vQmPabuKTEGpwD3bpSpxn1bS5jMJLLx8gC9k4o`
