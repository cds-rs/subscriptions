## A sponsor cannot revoke an active subscription — PASS
...
flowchart LR
    ...
    9iEJJhdY_Ui4z[("9iEJJhdY…Ui4z")]:::writable
    ...
    subscriptions -->|writes| 9iEJJhdY_Ui4z
    Token -->|writes| 9iEJJhdY_Ui4z
```
...
flowchart LR
    ...
    Token[Token]:::owner
    9iEJJhdY_Ui4z[("9iEJJhdY…Ui4z")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 9iEJJhdY_Ui4z
```
...
### The sponsor tries to revoke an active subscription

**RevokeSubscription (active): structured CPI tree**

```text

── subscriptions::RevokeDelegation ─────────────────────────
Transaction  signers=[sponsor]
└── subscriptions::RevokeDelegation [1] ✗ 486cu  signer=sponsor
    └── Error: Unauthorized (0x82)
Error: custom program error: 0x82
Compute Units (this run): 486
Fee: 0 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
  sponsor       = 47cncVPgU4mK37H7VvxLCCsoDEKYaVhNLHHp4MbnEwvx
