## AUDIT 3.1.4 (regression): the fix refuses the extended-end_ts ghost plan — PASS
...
- [x] the fix refuses the post-original-end pull (PlanTermsMismatch): `false`
- [x] the merchant siphoned nothing — the pull was refused: `0`
