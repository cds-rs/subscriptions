## Cancel rejects a non-subscriber — PASS
...
flowchart LR
    ...
    FxRJF4Qa_9msN[("FxRJF4Qa…9msN")]:::writable
    ...
    subscriptions -->|writes| FxRJF4Qa_9msN
    Token -->|writes| FxRJF4Qa_9msN
```
...
flowchart LR
    ...
    Token[Token]:::owner
    FxRJF4Qa_9msN[("FxRJF4Qa…9msN")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| FxRJF4Qa_9msN
```
...
### Mallory attempts to cancel Alice's subscription

**CancelSubscription (non-subscriber): structured CPI tree**

```text

── subscriptions::CancelSubscription ───────────────────────
Transaction  signers=[mallory]
└── subscriptions::CancelSubscription [1] ✗ 366cu  signer=mallory
