...
sequenceDiagram
    ...
    participant System
    participant Token
    alice ->> subscriptions: InitSubscriptionAuthority (22520cu)
...
sequenceDiagram
    ...
    subscriptions -->>- alice: ok (22520cu)
```
...
flowchart LR
    ...
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    subscriptions -->|owns| Bob_delegation
```
...
flowchart LR
    ...
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    subscriptions -->|owns| Charlie_delegation
```
