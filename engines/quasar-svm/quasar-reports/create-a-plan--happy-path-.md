...
- [x] the plan mint is the USDC mint: `111S1d9dJA6NS2j95MQ7A2eDjAgdAKXDjvxQg5d8pa`
- [x] the amount is 1_000_000: `1000000`
- [x] the period is 720 hours: `720`
- [x] the end timestamp matches: `1702592000`
- [x] the first destination is recorded: `111V4D5zGGPzhpX2QHduCfQfYQLv3gY5jrvGPnWRff`
- [x] the first puller is recorded: `111WRtzL16SDQNnFFxBJDWKZnYSrdmM9rjhXo9crV4`
