...
flowchart LR
    ...
    8Y6zk1ay_dymm[("8Y6zk1ay…dymm")]:::writable
    ...
    subscriptions -->|writes| 8Y6zk1ay_dymm
    Token_2022 -->|writes| 8Y6zk1ay_dymm
```
...
flowchart LR
    ...
    8Y6zk1ay_dymm[("8Y6zk1ay…dymm")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| 8Y6zk1ay_dymm
```
