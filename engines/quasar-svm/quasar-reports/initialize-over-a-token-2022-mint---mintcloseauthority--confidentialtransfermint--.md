...
flowchart LR
    ...
    8yDeHve4_Xf4Z[("8yDeHve4…Xf4Z")]:::writable
    ...
    subscriptions -->|writes| 8yDeHve4_Xf4Z
    Token_2022 -->|writes| 8yDeHve4_Xf4Z
```
...
flowchart LR
    ...
    8yDeHve4_Xf4Z[("8yDeHve4…Xf4Z")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| 8yDeHve4_Xf4Z
```
