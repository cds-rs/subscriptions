...
flowchart LR
    ...
    2cWdbcBA_b9Kp[("2cWdbcBA…b9Kp")]:::writable
    ...
    subscriptions -->|writes| 2cWdbcBA_b9Kp
    Token_2022 -->|writes| 2cWdbcBA_b9Kp
```
...
flowchart LR
    ...
    2cWdbcBA_b9Kp[("2cWdbcBA…b9Kp")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| 2cWdbcBA_b9Kp
```
