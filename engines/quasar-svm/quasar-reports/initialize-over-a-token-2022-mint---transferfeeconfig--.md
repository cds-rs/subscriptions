...
└── subscriptions::InitSubscriptionAuthority [1] ✓ 19365cu  signer=alice
    ├── System::CreateAccount [2] ✓ (no cu)
    └── Token-2022::Approve [2] ✓ 951cu
Compute Units (this run): 19365
Fee: 0 lamports
Legend (2):
...
sequenceDiagram
    ...
    alice ->> subscriptions: InitSubscriptionAuthority (19365cu)
...
sequenceDiagram
    ...
    subscriptions -->>- alice: ok (19365cu)
```
...
flowchart LR
    ...
    Amkx2Cqd_3vFm[("Amkx2Cqd…3vFm")]:::writable
    ...
    subscriptions -->|writes| Amkx2Cqd_3vFm
    Token_2022 -->|writes| Amkx2Cqd_3vFm
```
...
flowchart LR
    ...
    Amkx2Cqd_3vFm[("Amkx2Cqd…3vFm")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| Amkx2Cqd_3vFm
```
