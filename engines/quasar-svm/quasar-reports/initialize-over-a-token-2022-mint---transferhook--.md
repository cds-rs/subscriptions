...
flowchart LR
    ...
    GEu8TwrC_ST1N[("GEu8TwrC…ST1N")]:::writable
    ...
    subscriptions -->|writes| GEu8TwrC_ST1N
    Token_2022 -->|writes| GEu8TwrC_ST1N
```
...
flowchart LR
    ...
    GEu8TwrC_ST1N[("GEu8TwrC…ST1N")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token_2022 -->|owns| GEu8TwrC_ST1N
```
