...
sequenceDiagram
    ...
    participant subscriptions
    participant System
    alice ->> subscriptions: CreateRecurringDelegation (12573cu)
    subscriptions ->> System: CreateAccount
```
...
sequenceDiagram
    ...
    subscriptions ->>+ System: CreateAccount
    System -->>- subscriptions: ok
    subscriptions -->>- alice: ok (12573cu)
```
...
sequenceDiagram
    ...
    participant subscriptions
    participant Token
    bob ->> subscriptions: TransferRecurring (14831cu)
...
flowchart LR
    ...
    SubAuthority([SubAuthority]):::signer
    ANS2ncX5_9A2Q[("ANS2ncX5…9A2Q")]:::writable
    zNAKXSyW_Fmpc[("zNAKXSyW…Fmpc")]:::writable
    bob([bob]):::signer
    Token[Token]:::program
    ...
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| ANS2ncX5_9A2Q
    subscriptions -->|writes| zNAKXSyW_Fmpc
    Token -->|writes| ANS2ncX5_9A2Q
    Token -->|writes| zNAKXSyW_Fmpc
```
...
flowchart LR
    ...
    Token[Token]:::owner
    ANS2ncX5_9A2Q[("ANS2ncX5…9A2Q")]:::account
    zNAKXSyW_Fmpc[("zNAKXSyW…Fmpc")]:::account
    subscriptions -->|owns| RecurringDelegation
    subscriptions -->|owns| SubAuthority
    Token -->|owns| ANS2ncX5_9A2Q
    Token -->|owns| zNAKXSyW_Fmpc
```
