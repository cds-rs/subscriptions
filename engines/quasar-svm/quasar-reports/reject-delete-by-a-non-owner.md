## Reject delete by a non-owner — PASS
...
### Mallory tries to delete a plan she does not own

**DeletePlan (not owner): structured CPI tree**

```text

── subscriptions::DeletePlan ───────────────────────────────
Transaction  signers=[mallory]
└── subscriptions::DeletePlan [1] ✗ 221cu  signer=mallory
    └── Error: NotPlanOwner (0x1f8)
Error: custom program error: 0x1f8
Compute Units (this run): 221
Fee: 0 lamports
Legend (2):
  subscriptions = De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44
...
- [x] the plan survives the unauthorized delete: `true`
