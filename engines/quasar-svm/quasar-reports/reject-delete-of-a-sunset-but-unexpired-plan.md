## Reject delete of a sunset but unexpired plan — PASS
...
### The merchant tries to delete a sunset plan that has not yet expired

**DeletePlan (sunset, not expired): structured CPI tree**

```text

── subscriptions::DeletePlan ───────────────────────────────
Transaction  signers=[merchant]
└── subscriptions::DeletePlan [1] ✗ 357cu  signer=merchant
    └── Error: PlanNotExpired (0x203)
Error: custom program error: 0x203
