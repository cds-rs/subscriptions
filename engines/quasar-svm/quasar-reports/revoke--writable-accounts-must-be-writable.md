...
flowchart LR
    ...
    7D1BmEzv_YxKX[("7D1BmEzv…YxKX")]:::writable
    ...
    subscriptions -->|writes| 7D1BmEzv_YxKX
    Token -->|writes| 7D1BmEzv_YxKX
```
...
flowchart LR
    ...
    Token[Token]:::owner
    7D1BmEzv_YxKX[("7D1BmEzv…YxKX")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 7D1BmEzv_YxKX
```
