...
flowchart LR
    ...
    6rPSZygf_Eoev[("6rPSZygf…Eoev")]:::writable
    ...
    subscriptions -->|writes| 6rPSZygf_Eoev
    Token -->|writes| 6rPSZygf_Eoev
```
...
flowchart LR
    ...
    Token[Token]:::owner
    6rPSZygf_Eoev[("6rPSZygf…Eoev")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| 6rPSZygf_Eoev
```
