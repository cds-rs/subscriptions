...
flowchart LR
    ...
    SubAuthority([SubAuthority]):::signer
    HTDysK5e_AjMC[("HTDysK5e…AjMC")]:::writable
    8kM58MeK_Njux[("8kM58MeK…Njux")]:::writable
    bob([bob]):::signer
    Token[Token]:::program
    ...
    subscriptions -->|writes| SubAuthority
    subscriptions -->|writes| HTDysK5e_AjMC
    subscriptions -->|writes| 8kM58MeK_Njux
    Token -->|writes| HTDysK5e_AjMC
    Token -->|writes| 8kM58MeK_Njux
```
...
flowchart LR
    ...
    Token[Token]:::owner
    HTDysK5e_AjMC[("HTDysK5e…AjMC")]:::account
    8kM58MeK_Njux[("8kM58MeK…Njux")]:::account
    subscriptions -->|owns| RecurringDelegation
    subscriptions -->|owns| SubAuthority
    Token -->|owns| HTDysK5e_AjMC
    Token -->|owns| 8kM58MeK_Njux
```
