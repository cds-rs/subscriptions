...
sequenceDiagram
    ...
    participant System
    participant Token
    alice ->> subscriptions: InitSubscriptionAuthority (14296cu)
...
sequenceDiagram
    ...
    subscriptions -->>- alice: ok (14296cu)
```
