## Update a plan can clear its end_ts — PASS
...
### The merchant clears the end timestamp

**UpdatePlan (clear end_ts): structured CPI tree**
...
**UpdatePlan (clear end_ts): sequence diagram**
...
sequenceDiagram
    ...
    participant merchant
    participant subscriptions
    merchant ->> subscriptions: UpdatePlan (427cu)
```

**UpdatePlan (clear end_ts): sequence diagram, with lifelines**
...
sequenceDiagram
    ...
    subscriptions -->>- merchant: ok (427cu)
```

**UpdatePlan (clear end_ts): authority graph**
...
**UpdatePlan (clear end_ts): ownership graph**
...
- [x] the end timestamp is cleared: `0`
