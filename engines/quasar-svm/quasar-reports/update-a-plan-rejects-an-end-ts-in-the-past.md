## Update a plan rejects an end_ts in the past — PASS
...
### The merchant submits an end timestamp in the past

**UpdatePlan (end_ts in past): structured CPI tree**

```text

── subscriptions::UpdatePlan ───────────────────────────────
Transaction  signers=[merchant]
└── subscriptions::UpdatePlan [1] ✗ 379cu  signer=merchant
