## Update a plan rejects an invalid status — PASS
...
### The merchant submits a raw status value of 99

**UpdatePlan (invalid status): structured CPI tree**
...
└── subscriptions::UpdatePlan [1] ✗ 375cu  signer=merchant
    └── Error: InvalidPlanStatus (0x200)
Error: custom program error: 0x200
