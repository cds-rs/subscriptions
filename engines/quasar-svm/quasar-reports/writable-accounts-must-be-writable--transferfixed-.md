...
flowchart LR
    ...
    H2ZTsLAs_SpTa[("H2ZTsLAs…SpTa")]:::writable
    ...
    subscriptions -->|writes| H2ZTsLAs_SpTa
    Token -->|writes| H2ZTsLAs_SpTa
```
...
flowchart LR
    ...
    Token[Token]:::owner
    H2ZTsLAs_SpTa[("H2ZTsLAs…SpTa")]:::account
    System -->|owns| alice
    subscriptions -->|owns| SubAuthority
    Token -->|owns| H2ZTsLAs_SpTa
```
